...
HTML,
        ...
        'company_renewal_reminder' => [
            ...
            'placeholders' => ['user_name', 'company_name', 'plan_name', 'expires_at', 'days_left', 'request_url', 'billing_url', 'help_email', 'app_name'],
            'body' => <<<'HTML'
<p>Hello {{user_name}},</p>
...
HTML,
        ...
        'consultant_renewal_reminder' => [
            ...
            'placeholders' => ['user_name', 'company_name', 'plan_name', 'expires_at', 'contract_year', 'next_year', 'days_left', 'request_url', 'renewal_url', 'help_email', 'app_name'],
            'body' => <<<'HTML'
<p>Hello {{user_name}},</p>
