# MENetZero Consultant Portal Guide — Voice Help Knowledge

This document is the spoken-help version of the in-app **Consultant portal guide** (Help & Guide). Use it to help consultants and agency staff navigate the consultant panel and client workspaces.

**In-app guide pages:**
- [Consultant Help & Guide](https://app.menetzero.com/consultant/help)
- [Company portal guide](https://app.menetzero.com/consultant/company-portal-guide) (same company content, for when they work inside a client)

**Support:** [Consultant support](https://app.menetzero.com/consultant/support) or [Contact](https://app.menetzero.com/contact) → help@menetzero.com

When guiding a user, name the **sidebar menu item**, then give the **link**.
...
**Consultant register:** https://app.menetzero.com/consultant/register  
**Consultant landing:** https://app.menetzero.com/consultant  

Do not send consultants to the company `/login` for agency work.

---

## 3. Agency hub vs client workspace
...
## 4. Sidebar menu map (Consultant portal)
...
**Page:** [Dashboard](https://app.menetzero.com/consultant/dashboard)
...
**Page:** [Workspaces](https://app.menetzero.com/consultant/workspace)

Entering a workspace opens the **company portal as that client**. Header shows agency mode, which client, and PRY.

Steps:
1. Open Workspaces — list engagements with Enter / View.
2. **Enter workspace** — full edit access (subject to role).
3. **Read-only** — view without changes where offered.
4. **Exit** — Back to Agency Hub.
...
## 10. Directory profile, documents & leads

**Pages:**
- [Profile](https://app.menetzero.com/consultant/profile)
- [Documents](https://app.menetzero.com/consultant/documents)
- [Leads](https://app.menetzero.com/consultant/intro-requests)

Once approved, the practice appears on the public consultant directory. SMEs can request introductions.

Steps:
1. Profile — headline, services, regions, logo.
2. Documents — upload proof for verification.
3. Submit for review — status pending until approved.
4. Leads — respond to intro requests from companies.

Directory statuses: draft, pending review, approved, rejected.
...
1. [Consultant Help & guide](https://app.menetzero.com/consultant/help)
2. [Company portal guide](https://app.menetzero.com/consultant/company-portal-guide) for tool how-tos
