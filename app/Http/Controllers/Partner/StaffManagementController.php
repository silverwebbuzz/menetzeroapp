...
class StaffManagementController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('partner.staff.create', compact('customRoles', 'templates'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('partner.staff.index')
    ...
    {
        $company = Auth::user()->getActiveCompany();
        if (!$company || $company->company_type !== 'partner' || $access->company_id !== $company->id) {
            abort(403, 'Unauthorized action.');
        }
    ...
    {
        $company = Auth::user()->getActiveCompany();
        if (!$company || $company->company_type !== 'partner' || $invitation->company_id !== $company->id) {
            abort(403, 'Unauthorized action.');
        }
