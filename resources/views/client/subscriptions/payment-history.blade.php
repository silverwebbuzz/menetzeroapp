...
<div class="w-full">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">View all your subscription payments and invoices.</p>
    </div>
    ...
    <!-- Back Button -->
    <div class="mt-6">
        <a href="{{ route('subscriptions.index') }}" class="inline-flex items-center text-orange-600 hover:text-orange-800">
