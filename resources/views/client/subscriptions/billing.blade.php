...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-end gap-4">
        <a href="{{ route('subscriptions.current-plan') }}" class="px-6 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50">
            Back to Subscription
        </a>
        <a href="{{ route('subscriptions.payment-history') }}" class="px-6 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700">
