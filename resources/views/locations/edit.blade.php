        ...
        <form method="POST" action="{{ route('locations.update', $location) }}" id="location-edit-form">
            ...
            <div class="space-y-6">
                ...
                <div class="border-t pt-6">
                    <h4 class="text-md font-semibold text-gray-900 mb-4">Staff Details</h4>
                    
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Total number of staff (FTE)</label>
                            <p class="text-xs text-gray-500 mb-3">Staff are a source of indirect emissions. Include full-time, flexible, and remote employees.</p>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <label class="toggle-switch">
                                <input type="checkbox" name="staff_work_from_home" value="1" {{ old('staff_work_from_home', $location->staff_work_from_home) ? 'checked' : '' }} onchange="toggleWorkFromHomePercentage()">
                                <span class="slider"></span>
                            </label>
                        </div>
                        
                        <div id="wfh-percentage-section" class="{{ old('staff_work_from_home', $location->staff_work_from_home) ? '' : 'hidden' }}">
                ...
                <!-- Measurement Period -->
                <div class="border-t pt-6">
                    <h4 class="text-md font-semibold text-gray-900 mb-4">Measurement Period</h4>
