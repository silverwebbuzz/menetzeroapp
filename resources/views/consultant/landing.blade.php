...
@section('title', 'MENetZero Partner — Consultants & Agencies')

@section('content')
<div class="max-w-4xl mx-auto px-4 py-14">
    <div class="text-center mb-10">
        <span class="inline-block px-3 py-1 rounded-full bg-teal-50 text-teal-700 text-xs font-semibold mb-4">One partner account</span>
    ...
    <div class="grid md:grid-cols-3 gap-5 mb-12">
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <p class="text-sm text-gray-600 mt-2">Partner 5 for solo consultants from AED 6,495/yr. Add extra slots or year unlocks without upgrading pack size.</p>
        </div>
    </div>
    ...
    <div class="bg-slate-900 text-white rounded-2xl p-8 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-3">
            <a href="{{ route('consultant.register') }}" class="px-6 py-3 bg-teal-500 hover:bg-teal-400 text-white font-medium rounded-lg">Create partner account</a>
