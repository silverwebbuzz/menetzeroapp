...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/app-shell.css') }}?v=20260907c">
            ...
            <header class="header">
                ...
                <div class="header-actions">
                    ...
                    <!-- Zero AI — free ESG assistant -->
                        <a href="{{ route('consultant.zero-ai') }}"
                           class="header-btn header-btn--ai {{ request()->routeIs('consultant.zero-ai') ? 'is-active' : '' }}"
