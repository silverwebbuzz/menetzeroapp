...
@php
    // Get all Quick Input emission sources grouped by scope
...
<div x-data="{ 
    scope1Open: {{ request()->routeIs('quick-input.show') && request()->route('scope') == 1 ? 'true' : 'false' }},
    scope2Open: {{ request()->routeIs('quick-input.show') && request()->route('scope') == 2 ? 'true' : 'false' }},
    scope3Open: {{ request()->routeIs('quick-input.show') && request()->route('scope') == 3 ? 'true' : 'false' }}
}" class="space-y-1">
    <!-- Scope 1 -->
    <div>
        ...
        <div x-show="scope1Open" 
            ...
            @foreach($scope1Sources as $source)
                <a href="{{ route('quick-input.show', ['scope' => 1, 'slug' => $source->quick_input_slug]) }}" 
                   class="nav-link text-sm py-2 {{ request()->routeIs('quick-input.show') && request()->route('slug') == $source->quick_input_slug ? 'active' : '' }}">
