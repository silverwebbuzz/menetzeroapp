@php
    ...
    // Consultant portal is unlisted while the company packages are the focus.
    // Routes still work; these links are simply not shown. See config/portals.php.
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="mkt-desktop-nav">
                ...
                <div class="mkt-auth-menus">
                    ...
                    @else
                        {{-- One audience, so the "Company" dropdown has nothing to
                             disambiguate against -- sign in and sign up go straight
                             into the bar. --}}
                        <a href="{{ route('login') }}" class="mkt-btn mkt-btn-outline mkt-btn-sm">Sign in</a>
        ...
        <div class="mkt-mobile-menu lg:hidden" :class="{ 'is-open': menuOpen }">
            <div class="flex flex-col gap-1 pb-4">
                ...
                <div class="flex flex-col gap-2 px-1">
                    <a href="{{ route('login') }}" class="mkt-btn mkt-btn-outline mkt-btn-block mkt-btn-sm">{{ $showConsultant ? 'Company sign in' : 'Sign in' }}</a>
                    <a href="{{ route('register') }}" class="mkt-btn mkt-btn-primary mkt-btn-block mkt-btn-sm">{{ $showConsultant ? 'Company sign up' : 'Sign up' }}</a>
                </div>
