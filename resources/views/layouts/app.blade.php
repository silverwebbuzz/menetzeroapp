...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen">
        @auth
            ...
            <a href="{{ route('locations.index') }}" class="sidebar-link {{ request()->routeIs('locations.*') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                Locations
                        ...
                        <a href="{{ route('measurements.index') }}" class="sidebar-link {{ request()->routeIs('measurements.*') ? 'sidebar-link-active' : 'sidebar-link-inactive' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
