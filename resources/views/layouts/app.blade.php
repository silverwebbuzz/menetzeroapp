    ...
    <div>
        @auth
            ...
            <div class="sidebar" id="sidebar" style="transform: translateX(-100%);">
                ...
                <nav class="mt-8 px-4">
            <a href="{{ (auth()->user() && auth()->user()->company && auth()->user()->company->company_type === 'partner') ? route('partner.dashboard') : route('client.dashboard') }}" class="nav-link {{ (request()->routeIs('client.dashboard') || request()->routeIs('partner.dashboard')) ? 'active' : '' }}">
            ...
            @if($hasCompany)
                        ...
                        <a href="{{ (auth()->user()->company && auth()->user()->company->company_type === 'partner') ? route('partner.staff.index') : route('staff.index') }}" class="nav-link {{ (request()->routeIs('staff.*') || request()->routeIs('partner.staff.*')) ? 'active' : '' }}">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ (auth()->user()->company && auth()->user()->company->company_type === 'partner') ? route('partner.roles.index') : route('roles.index') }}" class="nav-link {{ (request()->routeIs('roles.*') || request()->routeIs('partner.roles.*')) ? 'active' : '' }}">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
