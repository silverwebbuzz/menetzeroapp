...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Select a new plan to upgrade or downgrade your partner subscription.</p>
    </div>
    ...
    <!-- Available Plans -->
    <form action="{{ route('partner.subscriptions.process-upgrade') }}" method="POST">
        @csrf
        ...
        <div class="flex items-center justify-end gap-4">
            <a href="{{ route('partner.subscriptions.index') }}" class="px-6 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50">
                Cancel
            </a>
