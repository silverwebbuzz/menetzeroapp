...
@section('title', 'Payment History - MenetZero')
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">View all your partner subscription payments and invoices.</p>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{ $subscription->plan->plan_name ?? 'N/A' }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $subscription->started_at->format('M d, Y') }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ ucfirst($subscription->payment_method ?? 'N/A') }}</div>
                        </td>
                    </tr>
                    @empty
                    <tr>
    ...
    <!-- Back Button -->
    <div class="mt-6">
        <a href="{{ route('partner.subscriptions.index') }}" class="inline-flex items-center text-orange-600 hover:text-orange-800">
