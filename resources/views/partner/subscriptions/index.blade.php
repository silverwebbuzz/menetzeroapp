...
<div class="max-w-7xl mx-auto">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Partner Subscription Plans</h1>
        <p class="mt-2 text-gray-600">Choose the plan that best fits your partner business needs.</p>
    </div>
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="{{ route('partner.subscriptions.current-plan') }}" class="px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50">
                    View Details
                </a>
                <a href="{{ route('partner.subscriptions.upgrade') }}" class="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700">
                    Change Plan
                </a>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg border-2 {{ $currentSubscription && $currentSubscription->subscription_plan_id == $plan->id ? 'border-orange-500 shadow-lg' : 'border-gray-200' }} p-6 hover:shadow-lg transition">
            ...
            @else
            <a href="{{ route('partner.subscriptions.upgrade', ['plan_id' => $plan->id]) }}" class="block w-full text-center px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition">
