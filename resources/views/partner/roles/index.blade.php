...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex justify-end mb-6">
        <a href="{{ route('partner.roles.create') }}" class="inline-flex items-center gap-2 px-6 py-3 border border-orange-500 text-orange-600 bg-white rounded-lg hover:bg-orange-50 transition">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('partner.roles.edit', $role) }}" class="text-orange-600 hover:text-orange-900 mr-4">Edit</a>
                            <form action="{{ route('partner.roles.destroy', $role) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
