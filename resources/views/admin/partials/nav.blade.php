...
<div class="px-3 space-y-6 text-sm">
    ...
    <div>
        ...
        <a href="{{ route('admin.emissions.index') }}"
           class="flex items-center gap-3 px-3 py-2 rounded-lg {{ str_starts_with($routeName, 'admin.emissions') ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-700 hover:bg-gray-50' }}">
            <span class="inline-flex items-center justify-center w-5 h-5">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
