...
@if (!empty($esgCards))
    ...
    {{-- Materiality snapshot REMOVED: Materiality is now its own Overview
         menu item (config/navigation.php), so the full matrix is one click
         away and a duplicate summary here would be a second place for the
         same numbers to drift. --}}
