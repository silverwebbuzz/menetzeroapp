{{--
    ...
    Uses plain Auth::guard()->check() rather than @auth/@elseauth so the markup
    is unambiguous, and url() rather than route() for the consultant and admin
    portals because neither has a named landing route — a bad route() call would
    throw while rendering the error page itself.
--}}
@php
