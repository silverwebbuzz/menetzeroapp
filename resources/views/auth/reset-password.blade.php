...
<head>
    ...
    <title>Reset Password - MenetZero</title>
            ...
            <div class="w-full max-w-md">
                ...
                <form class="mt-8 space-y-4" method="POST" action="{{ route('password.update') }}">
                    ...
                    <div>
                        ...
                        <input class="input" type="email" name="email" value="{{ $email }}" required readonly>
                    </div>
                    
                    <div>
                        <label class="block text-sm text-gray-600 mb-1">New Password</label>
                        <input class="input" type="password" name="password" required placeholder="Enter new password...">
                        @error('password')
                    ...
                    <div>
                        ...
                        <input class="input" type="password" name="password_confirmation" required placeholder="Confirm new password...">
                    </div>
                    ...
                    <button type="submit" class="btn-primary w-full rounded-xl py-3 font-medium">Reset Password</button>
                </form>
